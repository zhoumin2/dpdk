...
#define __la_war_llsc()               __asm__ __volatile__("ibar 0" : : :"memory")
...
static __inline__ void la_atomic32_##op(rte_atomic32_t *v, int32_t i) \
{                                                                     \
...
static __inline__ int32_t la_atomic32_##op##_and_return(rte_atomic32_t *v, int32_t i) \
{                                                                                     \
	int32_t result;                                                               \
                                                                                      \
	__asm__ __volatile__(                                                         \
...
static __inline__ void la_atomic64_##op(rte_atomic64_t *v, int64_t i) \
{                                                                     \
	__asm__ __volatile__(                                         \
...
static __inline__ int64_t la_atomic64_##op##_and_return(rte_atomic64_t *v, int64_t i) \
{                                                                                     \
	int64_t result;                                                               \
                                                                                      \
	__asm__ __volatile__(                                                         \
